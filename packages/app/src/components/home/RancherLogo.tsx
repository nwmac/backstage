...
const RancherLogo = () => {
  ...
  return (
    <div style={{display: 'flex', margin: '20px 0', flexDirection: 'column', alignItems: 'center'}}>
      <div>
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        viewBox="0 0 220 93.8" fill="#3D98D3" width="96">
      <g>
        <g>
    ...
    <div style={{whiteSpace: 'nowrap', marginTop: '10px', marginLeft: '5px', color: '#000', fontSize: '24px', fontWeight: 'bold' }}>Rancher Developer Portal</div>
    </div>
  );
};

export default RancherLogo;
