...
backend.add(import('@internal/backstage-plugin-catalog-backend-module-rancher-entity-provider'));
backend.add(import('@internal/backstage-plugin-auth-backend-module-rancher-auth'));
backend.start();
